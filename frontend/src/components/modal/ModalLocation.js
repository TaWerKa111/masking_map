    ...
    return (
        <Modal isOpen={isModal} onRequestClose={onClose}>
            <div className="text-center header-modal">
                <label className="h2 text-center">Выберите место проведения работ</label>
                <button className="float-end btn btn-close" onClick={onClose}></button>
            </div>
            <div>
                <p className="text-center">Выберите необходимые места проведения работ и нажмите на кнопку "Выбрать работы"</p>
            </div>
            <MnObjectQuestions
